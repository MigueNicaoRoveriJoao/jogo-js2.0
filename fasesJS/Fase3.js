...
backgroundLayer1.src = '/ImagensDaMontanha/m3/2.png';

const backgroundLayer2 = new Image();
backgroundLayer2.src = '/ImagensDaMontanha/m3/3.png';

const backgroundLayer3 = new Image();
backgroundLayer3.src = '/ImagensDaMontanha/m3/4.png';

const backgroundLayer4 = new Image();
backgroundLayer4.src = '/ImagensDaMontanha/m3/5.png';

const backgroundLayer5 = new Image();
backgroundLayer5.src = '/ImagensDaMontanha/m3/7.png';

const backgroundLayer6 = new Image();
backgroundLayer6.src = '/ImagensDaMontanha/m3/IceGround.jpg';


const layer1 = new Layer(backgroundLayer1, 0.2); //ceu
const layer2 = new Layer(backgroundLayer2, 0.4); // nuvem
const layer3 = new Layer(backgroundLayer3, 0.5);//montanhas ao longe
const layer4 = new Layer(backgroundLayer4, 0.8); //montanha com o rio
